  ...
  const drawer = (
    <div>
      ...
      <List>
        {menus?.map((menu) => {
          const common =
            "flex items-center gap-x-3 py-2 px-5 w-full hover:bg-gray-100 hover:rounded-lg";
            ...
            <div className="flex items-center gap-x-4 px-3">
              <NavLink
                ...
                className={({ isActive }) =>
                  isActive
                    ? common +
                      "border border-r-4  border-blue-600 rounded-l-lg text-blue-600 bg-[#e8eef7] w-full"
                    : common
                }
              >
        ...
        >
          ...
          <Collapse in={open} timeout="auto" unmountOnExit>
            {submenu?.map((menu) => {
              const common =
                "flex items-center gap-x-3 py-2 ml-5 px-5 w-full hover:bg-gray-100 hover:rounded-lg";
